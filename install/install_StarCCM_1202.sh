...
axel -n 50 -q http://azbenchmarkstorage.blob.core.windows.net/cdadapcobenchmarkstorage/STAR-CCM+12.02.010_01_linux-x86_64.tar.gz && tar zxf STAR-CCM+12.02.010_01_linux-x86_64.tar.gz
